        ...
        <div class="row">
            <div class="col-12">
                <table class="table">
                    ...
                    <tbody>
                        <?php while($order = mysqli_fetch_assoc($queryPendingpay)): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('คุณแน่ใจหรือว่าต้องการยกเลิกคําสั่งซื้อ');" href="<?php echo $base_url; ?>/order_delete.php?id=<?php echo $order['or_ID']; ; ?>" class="btn btn-outline-danger">ลบ</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
