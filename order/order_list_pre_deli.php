<?php if($rowsPreparingDelivery > 0): ?>
        ...
        <div class="row">
            <div class="col-12">
                <table class="table">
                    ...
                    <tbody>
                        <?php while($order = mysqli_fetch_assoc($queryPreparingDelivery)): ?>
                            <tr>
...
<?php else: ?>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h4 class="text-center text-danger">ไม่มีการเตรียมคําสั่งซื้อการจัดส่ง</h4>
            </div>
        </div>
    </div>
<?php endif; ?>
