...
<body>
  ...
  foreach ($images as $image) {
    echo '<div class="modal fade" id="ReadModal' . $image['news_ID'] . '" tabindex="-1" aria-labelledby="ReadModalLabel" aria-hidden="true">';
    echo '<div class="modal-dialog modal-dialog-centered">';
    echo '  <div class="modal-content">';
    echo '    <div class="modal-header">';
    echo '      <h5 class="modal-title" id="ReadModalLabel">' . $image['news_title'] . '</h5>';
    echo '      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>';
    echo '    </div>';
    echo '    <div class="modal-body">';
    echo '      <p>' . $image['news_detail'] . '</p>';
    echo '      <div class="card-img">';
