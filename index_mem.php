...
<head>
    ...
    <style>
        ...
        .btn-dark {
            background-color: #ffb923 !important; /* เปลี่ยนสีปุ่มเป็นสีส้ม */
            border-color: #ffb923 !important; /* เปลี่ยนสีเส้นขอบปุ่มเป็นสีส้ม */
            color: #000000 !important; /* เปลี่ยนสีข้อความเป็นสีดำ */
        }
                        ...
                        <div class="container" style="margin-top: 30px;">
                            ...
                            <form class="mb-3" method="GET" action="">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control" placeholder="ใส่ชื่อสินค้า" value="<?php echo htmlspecialchars($search); ?>">
                                        ...
                                        <div class="col-3 mb-3">
                                            <div class="card" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text text-success fw-bold mb-0"><?php echo $product['p_price'] ;?> บาท</p>
                                                    <p class="card-text text-muted mb-0"><?php echo nl2br($product['p_detail']); ?></p>
                                                   
                                                    <?php if($product['p_qty'] > 0): ?>
                                                        <a href="<?php echo $base_url;?>/cart_add.php?id=<?php echo $product['product_ID']; ?>" class="btn btn-dark w-100" ><i class="fa-solid fa-cart-shopping me-2"></i>เพิ่มสินค้า</a>
                                                    <?php else: ?>
