...
<div class="container mt-5">
    <div class="row justify-content-left">
        <div class="col-md-6">
            <div class="card card-lg" style="width: 70rem;">
                                            ...
                                            <?php if($rows > 0): ?>
                                                <?php while($product = mysqli_fetch_assoc($query)): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a role="button" href="<?php echo $base_url; ?>/admin/day.php?days_ID=<?php echo $product['days_ID']; ?>" class="btn btn-outline-dark" onclick="showDetail()"><i class="fa-solid fa-pen-to-square me-1"></i>แก้ไข</a>
                                                            <a onclick="return confirm('Are you sure you want to delete?');" href="<?php echo $base_url; ?>/admin/day_delete.php?id=<?php echo $product['days_ID']; ?>" class="btn btn-outline-danger"><i class="fa-solid fa-delete-left me-1"></i>ลบ</a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="5"><h4 class="text-center text-danger">ไม่มีข้อมูลวันสำคัญ</h4></td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                        ...
                        <div class="container" style="margin-top: 30px;">
                            <div class="row g-5">
                                <div class="col-md-8 col-sm-12">
                                    <form id="productForm" action="<?php echo $base_url; ?>../admin/days_form.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php endif; ?>
                                        <a role="button" class="btn btn-secondary" type="button" href="<?php echo $base_url; ?>/admin/day.php"><i class="fa-solid fa-rotate-left me-1"></i>ลบ</a>
                                    </form>
                                </div>
                            </div>
                        </div>
