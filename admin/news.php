        ...
        <div class="col-md-6">
            <div class="card card-lg" style="width: 80rem;">
                <div class="card-header">
                    <button type="button" class="btn btn-dark" onclick="showGeneral()"><h4>รายการข่าว</h4></button>
                    <?php if($showAddForm): ?>
                        <button type="button" class="btn btn-dark" onclick="showAddForm()">เพิ่ม</button>
                    <?php endif; ?>
                    <a href="news_show.php"  type="button" class="btn btn-dark">อ่าน</a>
                </div>
                <div class="card-body">
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 200px;">เนื้อหาข้าว</th>
                                            ...
                                            <?php if($rows > 0): ?>
                                                <?php while($product = mysqli_fetch_assoc($query)): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a role="button" href="<?php echo $base_url; ?>/admin/news.php?news_ID=<?php echo $product['news_ID']; ?>" class="btn btn-outline-dark" onclick="showDetail()"><i class="fa-solid fa-pen-to-square me-1"></i>แก้ไข</a>
                        ...
                        <div class="container" style="margin-top: 30px;">
                            <div class="row g-5">
                                <div class="col-md-8 col-sm-12">
                                    <form id="productForm" action="<?php echo $base_url; ?>/admin/news_form.php" method="post" enctype="multipart/form-data">
                                        <div class="row g-3 mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="form-label">เนื้อหาข้าว</label>
                                        ...
                                        <?php endif; ?>
                                        <a role="button" class="btn btn-secondary" type="button" href="<?php echo $base_url; ?>/admin/index_admin.php"><i class="fa-solid fa-rotate-left me-1"></i>ลบ</a>
                                    </form>
                                </div>
                            </div>
                        </div>
