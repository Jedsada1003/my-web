            ...
            <div class="card card-lg" style="width: 80rem;">
                <div class="card-header">
                    <div class="btn-group" role="group" aria-label="Properties File">
                        <button type="button" class="btn text-dark" onclick="showGeneral()">สินค้า</button>
                        <button type="button" class="btn text-dark" onclick="showCalendar()">ปฏิทิน</button>
                                            ...
                                            <div class="card" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <?php if($product['p_qty'] > 0): ?>
                                                        <a href="<?php echo $base_url;?>/owner/cart_add.php?id=<?php echo $product['product_ID']; ?>" class="btn btn-dark w-100" ><i class="fa-solid fa-cart-shopping me-2"></i>เพิ่มสินค้า</a>
                                                    <?php else: ?>
