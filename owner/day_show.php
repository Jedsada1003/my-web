...
<div class="row justify-content-center">
        <div class="col-md-8">
        <div class="card card-lg mx-auto" style="width: 65rem;">
                <div class="card-header">
                <a href="day.php"  type="button" class="btn btn-primary">Back</a>
                            ...
                            <div class="col">
                                ...
                                <img src="../upload_img/artcle/maka.jpg" class="card-img-top" alt="Article Image" width="500%" height="500%">
                                    <div class="card-body">
                                        ...
                                        <a href="./days_arc/maka.php" class="btn btn-primary w-100"><i class="fa-solid fa-newspaper me-2"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <img src="../upload_img/artcle/visa.jpg" class="card-img-top" alt="Article Image"  width="500%" height="500%">
                                    <div class="card-body">
                                        ...
                                        <a href="./days_arc/visa.php" class="btn btn-primary w-100"><i class="fa-solid fa-newspaper me-2"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Add more cards for other articles here -->
                            <div class="col">
                                ...
                                <img src="../upload_img/artcle/autti.jpg" class="card-img-top" alt="Article Image"  width="500%" height="500%">
                                    <div class="card-body">
                                        ...
                                        <a href="./days_arc/autti.php" class="btn btn-primary w-100"><i class="fa-solid fa-newspaper me-2"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Add more cards for other articles here -->
                            <div class="col">
                                ...
                                <img src="../upload_img/artcle/aasa.jpg" class="card-img-top" alt="Article Image" width="500%" height="500%">
                                    <div class="card-body">
                                        ...
                                        <a href="./days_arc/aasa.php" class="btn btn-primary w-100"><i class="fa-solid fa-newspaper me-2"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Add more cards for other articles here -->
                            <div class="col">
                                ...
                                <img src="../upload_img/artcle/in.jpg" class="card-img-top" alt="Article Image"  width="500%" height="500%">
                                    <div class="card-body">
                                        ...
                                        <a href="./days_arc/in.php" class="btn btn-primary w-100"><i class="fa-solid fa-newspaper me-2"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Add more cards for other articles here -->
                            <div class="col">
                                ...
                                <img src="../upload_img/artcle/out.jpg" class="card-img-top" alt="Article Image"  width="500%" height="500%">
                                    <div class="card-body">
                                        ...
                                        <a href="./days_arc/out.php" class="btn btn-primary w-100"><i class="fa-solid fa-newspaper me-2"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
