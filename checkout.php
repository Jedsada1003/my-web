...
<div class="container" style="margin-top: 30px;">
    ...
    <?php endif; ?>
    <form action="<?php echo $base_url ?>/checkout_f.php" method="post" enctype="multipart/form-data">
        <div class="row g-5">
            <div class="col-md-6 col-lg-7">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <label class="form-label">รูปแบบการจัดสินค้า</label><br>
...
<label for="option2">ไม่จัดลงถังสังฆทาน</label><br>
                    </div>
                    <div class="col-sm-6">
                ...
                <hr class="my-4">
                <div class="text-end">
                    <a href="<?php echo $base_url; ?>/pd_list.php" class="btn btn-secondary btn-lg" role="button">กลับ</a>
                    <button type="submit" class="btn btn-success btn-lg">ดำเนินการชำระสินค้า</button>
                </div>
            </div>
            <div class="col-md-6 col-lg-5 order-md-last">
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    <span class="text-dark">ตะกร้าสินค้า</span>
